...
import com.music.app.adapter.AdminSongAdapter
...
import com.music.app.databinding.ActivityAdminCategorySongBinding
...
class AdminCategorySongActivity : BaseActivity() {

    private var binding: ActivityAdminCategorySongBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAdminCategorySongBinding.inflate(layoutInflater)
    ...
    private fun initToolbar() {
        ...
        binding?.toolbar?.tvTitle?.text = mCategory!!.name
    }

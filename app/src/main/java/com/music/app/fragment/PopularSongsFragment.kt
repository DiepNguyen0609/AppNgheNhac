...
import com.music.app.databinding.FragmentPopularSongsBinding
...
class PopularSongsFragment : Fragment() {
    ...
    private var binding: FragmentPopularSongsBinding? = null
    private var mListSong: MutableList<Song>? = null
    private var mSongAdapter: SongAdapter? = null

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
                              savedInstanceState: Bundle?): View? {
        binding = FragmentPopularSongsBinding.inflate(inflater, container, false)
        initUi()
        initListener()
